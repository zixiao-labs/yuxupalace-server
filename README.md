...
支持[Logos](https://github.com/zixiao-labs/logos)、~~[Zed](https://github.com/amiya167/zed支持[Logos](https://github.com/zixiao-labs/logos)、~~ 由于官方暂时Out Of Scope，Zed支持将通过扩展程序提供、CLI客户端，并会推出手机客户端
